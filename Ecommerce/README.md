...
La tabla `Products` almacena productos con los campos `sku`, `long_descripcion`, `short_descripcion`, `stock` y `regular_price`; el `sku` se configura como único y `regular_price` usa precisión decimal `18,2`.
